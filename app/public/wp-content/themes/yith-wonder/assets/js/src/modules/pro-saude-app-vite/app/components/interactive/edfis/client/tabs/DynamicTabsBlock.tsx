...
import { getNumCol, runAutoFill } from "../../../../../src/lib/locals/edFisNutPage/edFisNutHandler";
import { DTsCtxProps, ENCtxProps, FspCtxProps, TargInps } from "../../../../../src/lib/global/declarations/interfaces";
  ...
  return (
    <ErrorBoundary fallback={<GenericErrorComponent message='Error mounting dynamic tables!' />}>
      <DTsCtx.Provider value={{ exeAutoFillCtx }}>
        <TabMedAnt>
          <Suspense fallback={<ReactSpinner scale={0.3} key={new Date().getTime()} />}>
