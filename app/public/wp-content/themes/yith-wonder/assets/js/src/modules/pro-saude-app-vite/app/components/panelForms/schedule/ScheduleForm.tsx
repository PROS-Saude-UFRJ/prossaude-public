...
import { exporters, fillScheduleState, panelRoots, providers } from "../../../src/vars";
...
import { sessionScheduleState, panelFormsVariables, scheduleReset } from "../../../src/vars";
...
import { fetchSchedHours } from "../../../src/redux/slices/schedHoursSlice";
import { fetchSchedCols } from "../../../src/redux/slices/schedColsSlice";
import { PanelDispatch } from "../../../src/lib/global/declarations/interfacesRedux";
import { RootCtx } from "../../../src/App";
export default function ScheduleForm({ mainRoot, children = <></> }: ScheduleFormProps): JSX.Element {
  const userClass = useContext(PanelCtx).userClass,
    { divModal, divModalSec, divModalTerc } = useContext(RootCtx),
    fr = useRef<nlFm>(null),
    ...
    dispatch = useDispatch() as PanelDispatch;
  useEffect(() => {
  ...
  useEffect(() => {
    console.log(userClass ?? "NO USER CLASS");
