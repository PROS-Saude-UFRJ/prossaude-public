...
import { nlA, nlFm, nlHtEl, nlSpan } from "../../../src/lib/global/declarations/types";
import { useCallback, useEffect, useRef, useState } from "react";
import { callbackShowPw, callbackSubmitBtn } from "../../../src/lib/locals/loginPage/loginController";
import { assignFormAttrs, compProp, parseNotNaN } from "../../../src/lib/global/gModel";
...
export default function LoginInputs(): JSX.Element {
      ...
      (resSpan: nlHtEl): void => {
        try {
          ...
          if (!isSpinning) {
            ...
            setTimeout(() => navigate(`${location.pathname.replace(/\/+$/, "")}/base`), 1000);
          }
        } catch (e) {
          return;
        }
  ...
  return (
    <form
      ...
      <div role='group' className={`${sLp.loginInputCont1}`}>
        <div role='group' className={`${sLp.loginInputCont2}`} style={{ width: "93%" }}>
          <fieldset
            ...
            <input
              ...
              style={{ border: "none", boxShadow: "none", paddingTop: "0.5rem" }}
              id='pw'
              name='pw'
              type='password'
