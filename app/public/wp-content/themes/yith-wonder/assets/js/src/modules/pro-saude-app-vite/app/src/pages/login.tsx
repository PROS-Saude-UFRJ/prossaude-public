...
import { pageProps } from "../../src/vars";
            ...
            <div className={`${sLp.loginCont}`} role='group' id='loginCont'>
              <section id='logoCont'>
                <img
                  ...
                  id='logo'
                  src='../../public/img/PROS_Saude_Modelo1-Final.webp'
                  alt='logo'
                  width='322'
                  height='155'
                  ...
                  onError={e =>
                    (e.currentTarget.src = `${location.origin}/wp-content/uploads/2024/11/PROS_Saude_Modelo1-Final.webp`)
                  }
                />
              </section>
