...
import { nlHtEl, nlA, nlDiv } from "../../../src/lib/global/declarations/types";
...
export default function NavCard({ href }: { href: string }): JSX.Element {
            ...
            <fieldset className={`${sMc.addTextBack}`}>
              <button className={`btn btn-info card-hborder transparentEl ${sMc.btnBack}`} id='agAnchoredBtn'>
                <Link
                  ...
                  id='ag_but'
                  target='_self'
                  to={`${location.origin}/interno/ag`.replace(/\/{2,}/g, "/")}
                  rel='nofollow'
            ...
            <fieldset className={`${sMc.addTextBack}`}>
              <button
                ...
                <Link
                  ...
                  id='ed_but'
                  target='_self'
                  to={`${location.origin}/interno/edfis`.replace(/\/{2,}/g, "/")}
                  rel='nofollow'
                  style={{ fontWeight: "bold" }}>
                  Acesse aqui
                </Link>
            ...
            <fieldset className={`${sMc.addTextBack}`}>
              <button className={`btn btn-primary card-hborder transparentEl ${sMc.btnBack}`} id='agAnchoredBtn'>
                <Link
                  ...
                  id='ed_but'
                  target='_self'
                  to={`${location.origin}/interno/od`.replace(/\/{2,}/g, "/")}
                  rel='nofollow'
                  style={{ fontWeight: "bold" }}>
                  Acesse aqui
                </Link>
  ...
  return (
    <div id={`${href.replaceAll("/", "")}Card`} className={sMc.card} ref={r} data-turned={turned.current}>
      <div
        ...
        <figure
          ...
          <Link
            to={
              /nut/gi.test(href)
                ? `${location.origin}/interno/edfis`.replace(/\/{2,}/g, "/")
                : `${location.origin}/interno/${href}`.replace(/\/{2,}/g, "/")
            }
            ...
            <img
              ...
              src={`http://prossaude-ufrj.local/wp-content/uploads/2024/11/${
                /ag/g.test(href) ? "icon-psy" : `PROS_${href.replace("/", "")}_icon`
              }.webp`}
