import { DlgProps, RootCtxType } from "../../../src/lib/global/declarations/interfaces";
import { ErrorBoundary } from "react-error-boundary";
import { isClickOutside } from "../../../src/lib/global/gStyleScript";
import GenericErrorComponent from "../../error/GenericErrorComponent";
import st from "../../../src/styles/modules/declarationStyles.module.scss";
import DefaultDeclaration from "../def/DefaultDeclaration";
import useDialog from "../../../src/lib/hooks/useDialog";
import { memo, useContext } from "react";
import { NlMRef, nlSpan } from "../../../src/lib/global/declarations/types";
